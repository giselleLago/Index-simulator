...
namespace SP500Simulator
{
    public class Program
    {
        ...
        private static double CalculateYearReturn(double capital, double anualReturn)
        {
            var gain = capital * (anualReturn / 100);
            return capital + gain;
        }
